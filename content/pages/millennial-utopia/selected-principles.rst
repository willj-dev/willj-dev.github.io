...
These principles are expected to be true in any hypothetical society where the MSC is guaranteed universally and equally, but otherwise everything else is pretty much the same. For more information about whether or not such a society is possible in practice, see: `Proving MU Viability`_.
